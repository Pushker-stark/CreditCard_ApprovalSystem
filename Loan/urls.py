...
from .views import RegisterCustomerView, CheckEligibilityView, CreateLoanView, ViewLoanDetailsView, ViewCustomerLoansView
...
urlpatterns = [
    ...
    path('view-loan/<int:loan_id>/', ViewLoanDetailsView.as_view(), name='view-loan'),
